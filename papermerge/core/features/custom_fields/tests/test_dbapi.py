...
class TestCreateCustomField:
    ...
    @pytest.mark.asyncio
    async def test_create_text_field(self, db_session, user):
    ...
    @pytest.mark.asyncio
    async def test_create_monetary_field_with_config(self, db_session, user):
    ...
    @pytest.mark.asyncio
    async def test_create_field_for_group(self, db_session, make_group):
    ...
    @pytest.mark.asyncio
    async def test_create_date_field(self, db_session, user):
